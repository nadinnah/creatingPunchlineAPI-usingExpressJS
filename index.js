...
app.get("/random/", (req,res)=>{
  ...
  //object or array you pass to res.json() is automatically converted to a JSON string.
})

app.get("/jokes/:id", (req,res)=>{
  var id=req.params.id*1; //or parseInt(req.params.id) req.params not req.body
